...
export default function VTCPage() {
  ...
  const sendEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        alert(
          "✅ Demande reçue ! Vous allez recevoir votre devis par email très rapidement."
        );
        formEl.reset();
  ...
  return (
    <main className="relative min-h-screen font-sans text-slate-800 bg-slate-50 pt-32 xl:pt-36 flex flex-col">
            ...
            <form onSubmit={handleCallbackRequest} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  name="company"
                  placeholder="Ex: Mapetrans SAS"
                  className="w-full h-12 border border-slate-300 rounded-sm px-4 font-bold text-slate-800 outline-none focus:border-blue-700 bg-slate-50"
                />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">
              ...
              <button
                type="submit"
                className="w-full h-12 bg-slate-900 text-white font-bold uppercase tracking-wide rounded-sm hover:bg-black transition shadow-lg mt-2"
              >
                Me faire rappeler
              </button>
            </form>
        ...
        <nav className="border-b border-slate-200 h-20 md:h-24 flex items-center relative bg-white z-50">
          <div className="max-w-7xl mx-auto px-4 w-full flex justify-between items-center">
            ...
            <div className="hidden xl:flex items-center text-[10px] font-extrabold text-slate-600 tracking-widest uppercase">
              ...
              <Link
                href="/vtc"
                className="text-blue-700 px-4 py-2 flex items-center gap-2 group border-r border-slate-100 last:border-0"
              >
          ...
          <div className="fixed inset-0 top-28 z-40 bg-white border-t border-slate-100 p-6 flex flex-col gap-6 xl:hidden overflow-y-auto pb-32">
            <div className="flex flex-col gap-4 text-sm font-black uppercase tracking-wider text-slate-800">
              ...
              <Link
                ...
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <Truck className="w-5 h-5 text-blue-700" /> Logistique & Fret
              </Link>
              <Link
                href="/demenagement"
                className="flex items-center gap-4 p-4 bg-slate-50 rounded-lg border border-slate-100"
      ...
      <div className="relative h-[450px] w-full overflow-hidden flex items-center justify-center bg-slate-900">
        ...
        <div className="relative z-10 text-center px-4 animate-fade-in">
          ...
          <p className="text-slate-200 text-sm md:text-base max-w-2xl mx-auto font-medium leading-relaxed drop-shadow-md">
            Alternative Taxi pour vos navettes aéroports (Orly, Roissy), gares et{" "}
            <strong>courses express</strong>. <br />
            Service disponible 24h/7j pour tous vos trajets, sans restriction de distance.
          </p>
          <div className="mt-8 flex flex-col md:flex-row gap-4 justify-center items-center">
            <a
              href="tel:0634605799"
              className="bg-white text-slate-900 px-8 py-4 rounded-sm font-bold uppercase tracking-widest text-xs hover:bg-slate-100 transition shadow-lg inline-flex items-center gap-2 transform hover:scale-105 duration-300"
            >
              <Phone className="w-4 h-4" /> Appeler (Urgence)
            </a>
            <span className="text-white text-xs font-medium opacity-80 md:hidden">
              ou
            </span>
            <Link
              href="#booking"
      ...
      <div
        id="booking"
        className="relative z-20 px-4 max-w-5xl mx-auto w-full mt-12 mb-12 animate-fade-in delay-100"
      >
        <div className="bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Étape 1 : complétez votre trajet, on vous répond sous 24h.
                </p>
              </div>
            </div>
          ...
          <div className="px-6 md:px-8 pt-5 pb-3 border-b border-slate-100 bg-slate-50/60">
            <div className="flex items-center gap-3 md:gap-4">
              <button
                ...
                className={`flex-1 md:flex-none md:w-56 flex items-center justify-center gap-2 rounded-full text-xs font-bold uppercase tracking-wide border px-4 py-2 transition ${
                  activeStep === 1
          ...
          {/* Formulaire (même champs, même names) */}
          <form
            ref={form}
            onSubmit={sendEmail}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="space-y-5">
                  <h4 className="text-sm font-black text-blue-800 uppercase border-b border-slate-100 pb-2 flex items-center gap-2">
                    <MapPin className="w-4 h-4" /> Détails du trajet
                  </h4>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        name="date"
                        required
                        className="w-full h-10 border border-slate-300 rounded-sm px-3 text-sm font-medium focus:border-blue-600 outline-none bg-slate-50"
                      />
                    </div>
                    <div>
                      <label className="flex items-center justify-between text-[10px] font-bold text-slate-500 uppercase mb-1">
                        <span>Heure de Vol/Train</span>
                        <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="time"
                  ...
                  {/* Bouton Aller / Retour sous les dates pour ne pas casser le reste */}
                  <div className="flex items-center">
                    <button
                      type="button"
                      onClick={() => setIsRoundTrip(!isRoundTrip)}
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-[11px] font-bold uppercase tracking-wide transition border ${
                        isRoundTrip
                          ? "bg-blue-600 text-white border-blue-600 shadow-sm"
                    ...
                    >
                      ...
                      {isRoundTrip ? "Aller-Retour activé" : "Ajouter un retour"}
                    </button>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="depart"
                      placeholder="Ex: Saran, Olivet, Orléans..."
                      required
                      className="w-full h-10 border border-slate-300 rounded-sm px-3 text-sm font-medium focus:border-blue-600 outline-none"
                    />
                  </div>
                  <div>
                    <label className="flex items-center justify-between text-[10px] font-bold text-slate-500 uppercase mb-1">
                    ...
                    <input
                      type="text"
                      name="destination"
                      placeholder="Ex: Aéroport Orly Terminal 2..."
                      required
                      className="w-full h-10 border border-slate-300 rounded-sm px-3 text-sm font-medium focus:border-blue-600 outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        name="vol_train"
                        placeholder="Ex: AF1234 ou TGV 8540"
                        className="w-full h-10 border border-slate-300 rounded-sm pl-9 pr-3 text-sm font-medium focus:border-blue-600 outline-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <h4 className="text-sm font-black text-slate-700 uppercase border-b border-slate-100 pb-2">
                    Retour (facultatif)
                  </h4>
                  ...
                  {isRoundTrip ? (
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            name="date_retour"
                            required
                            className="w-full h-10 border border-slate-300 rounded-sm px-3 text-sm font-medium focus:border-blue-600 outline-none bg-white"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">
                          Adresse Dépose Retour (si différente départ)
                        </label>
                        <input
                          type="text"
                          name="destination_retour"
                          placeholder="Laisser vide si retour au point de départ"
                          className="w-full h-10 border border-slate-300 rounded-sm px-3 text-sm font-medium focus:border-blue-600 outline-none bg-white"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          name="vol_train_retour"
                          placeholder="Ex: AF9999"
                          className="w-full h-10 border border-slate-300 rounded-sm px-3 text-sm font-medium focus:border-blue-600 outline-none bg-white"
                        />
                      </div>
                    </div>
                    ...
                    <div className="text-xs text-slate-400 bg-slate-50 border border-dashed border-slate-200 rounded-md p-4">
                      Activez l&apos;option <span className="font-semibold">Aller-Retour</span> pour
                      renseigner vos informations de trajet retour.
                    </div>
                  )}
                  ...
                  <div className="flex justify-end pt-4">
                    ...
                    >
                      Étape suivante : Passagers & contact
            ...
            {activeStep === 2 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                <div className="md:col-span-2 space-y-5">
                  <h4 className="text-sm font-black text-blue-800 uppercase border-b border-slate-100 pb-2 flex items-center gap-2">
                    <User className="w-4 h-4" /> Passagers & Contact
                  </h4>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">
                      Information Spécifique (Optionnel)
                    </label>
                    <textarea
                      name="details"
                      placeholder="Siège bébé, animal, bagages volumineux, code porte..."
                      className="w-full h-24 border border-slate-300 rounded-sm px-3 py-2 text-sm font-medium focus:border-blue-600 outline-none resize-none"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-2">
                    <button
                      type="button"
                      onClick={() => setActiveStep(1)}
                      className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-slate-400 hover:text-slate-600"
                    >
                    ...
                    <button
                      type="submit"
                      disabled={isSending}
                      className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold h-11 px-6 rounded-sm uppercase tracking-wide text-xs shadow-lg transition-all disabled:opacity-50 hover:scale-[1.02] active:scale-[0.98]"
                    >
                      {isSending ? (
                        <>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">
                    Paiement sécurisé à bord ou sur facture.
                  </p>
                </div>
                ...
                <aside className="bg-slate-50 border border-slate-200 rounded-xl p-5 flex flex-col justify-between">
                      ...
                      <li className="flex gap-2">
                        ...
                        <div>
                          <p className="font-semibold text-slate-800">
                            Devis précis sous 24h
                          </p>
                          <p className="text-[11px] text-slate-500">
                            Vous recevez votre tarif par email avec tous les détails du trajet.
                          </p>
                        </div>
                      </li>
                      <li className="flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500">
                            Prise en charge tôt le matin, tard le soir, week-ends et jours fériés.
                          </p>
                        </div>
                      </li>
                      <li className="flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500">
                            Le véhicule est 100% réservé pour vous et vos accompagnants.
                          </p>
                        </div>
                      </li>
                    </ul>
                  ...
                  <div className="mt-4 pt-3 border-t border-dashed border-slate-200">
                    <p className="text-[11px] text-slate-500 mb-2">
                      Pour un devis immédiat par téléphone :
                    </p>
                    <a
                      href="tel:0634605799"
                      className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-blue-700 hover:text-blue-900"
                    >
      ...
      <div className="max-w-7xl mx-auto px-4 w-full pb-16 animate-fade-in delay-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="p-6 space-y-4">
              <div className="flex justify-between border-b border-slate-100 pb-2">
                ...
                <span className="text-xl font-black text-slate-800">180 €</span>
              </div>
              <div className="flex justify-between border-b border-slate-100 pb-2">
                <span className="text-sm font-bold text-slate-500">
                  4 à 6 Passagers
                </span>
                <span className="text-xl font-black text-slate-800">210 €</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm font-bold text-slate-500">
                  7 à 8 Passagers
                </span>
                <span className="text-xl font-black text-slate-800">230 €</span>
              </div>
            </div>
          </div>
          {/* ROISSY */}
          <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between border-b border-slate-100 pb-2">
                ...
                <span className="text-xl font-black text-slate-800">240 €</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm font-bold text-slate-500">
                  6 à 8 Passagers
                </span>
                <span className="text-xl font-black text-slate-800">260 €</span>
              </div>
            </div>
          </div>
          {/* PARIS */}
          ...
          <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden flex flex-col hover:-translate-y-1 transition duration-300">
            <div className="h-32 bg-slate-800 relative overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1570710891163-6d3b5c47248b?q=80&w=800"
                className="absolute inset-0 w-full h-full object-cover opacity-40"
                alt="Beauvais"
              />
              <div className="absolute inset-0 flex items-center justify-between px-6 text-white">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between border-b border-slate-100 pb-2">
                ...
                <span className="text-xl font-black text-slate-800">340 €</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm font-bold text-slate-500">
                  7 à 8 Passagers
                </span>
                <span className="text-xl font-black text-slate-800">380 €</span>
              </div>
            </div>
          </div>
          {/* TOURS */}
          <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden flex flex-col hover:-translate-y-1 transition duration-300">
            <div className="h-32 bg-blue-900 relative overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1473862170180-84427c485aca?q=80&w=800&auto=format&fit=crop"
                className="absolute inset-0 w-full h-full object-cover opacity-40"
                alt="Tours"
              />
              <div className="absolute inset-0 flex items-center justify-between px-6 text-white">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between border-b border-slate-100 pb-2">
                ...
                <span className="text-xl font-black text-slate-800">220 €</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm font-bold text-slate-500">
                  7 à 8 Passagers
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-600">
              <li className="flex justify-between border-b border-slate-100 pb-3">
                <span className="flex items-center gap-2">
                  <Moon className="w-4 h-4 text-slate-400" /> Nuit (20h-05h)
                </span>
                <span className="text-slate-900 font-bold">+20€</span>
              </li>
              <li className="flex justify-between border-b border-slate-100 pb-3">
                <span className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-slate-400" /> Dimanche & Férié
                </span>
                <span className="text-slate-900 font-bold">+20€</span>
              </li>
              <li className="flex justify-between border-b border-slate-100 pb-3">
                <span className="flex items-center gap-2">
                  <Briefcase className="w-4 h-4 text-slate-400" /> Bagages supp.
                </span>
              ...
              <li className="flex justify-between">
                <span className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-slate-400" /> Hors Agglo (&gt;10km)
                </span>
                <span className="text-slate-900 font-bold">
                  0,80€{" "}
                  <span className="text-[10px] font-normal text-slate-400">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
                Mapetrans.LD est le partenaire privilégié des entreprises du Loiret
                pour la gestion des déplacements collaborateurs et VIP. Solutions sur
                mesure adaptées à vos besoins réguliers.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-sm font-medium">
                  <CheckCircle className="w-5 h-5 text-blue-500" /> Facturation
                  mensuelle fin de mois
                </li>
                <li className="flex items-center gap-3 text-sm font-medium">
                  <CheckCircle className="w-5 h-5 text-blue-500" /> Navettes
                  régulières (Matin/Soir)
                </li>
                <li className="flex items-center gap-3 text-sm font-medium">
                  <CheckCircle className="w-5 h-5 text-blue-500" /> Priorité de
                  réservation & Ligne dédiée
                </li>
              </ul>
              <div className="mt-8">
                <button
                  onClick={() => setIsCallbackModalOpen(true)}
                  className="inline-flex items-center gap-2 text-blue-400 font-bold uppercase text-xs hover:text-white transition group"
                >
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 backdrop-blur-sm">
              ...
              <p className="text-xs text-slate-400 mb-6">
                Mise en place de lignes régulières pour le transport de vos équipes
                vers Gares & Aéroports.
              </p>
              <div className="h-px w-full bg-white/10 mb-6" />
              <Building2 className="w-10 h-10 text-blue-500 mb-4" />
              <h3 className="text-xl font-bold mb-2">Événementiel</h3>
              <p className="text-xs text-slate-400">
                Gestion logistique complète pour vos séminaires, congrès et visites
        ...
        <div className="mb-12">
          <h2 className="text-2xl md:text-3xl font-black text-slate-900 uppercase text-center mb-10">
            Pourquoi choisir VTC plutôt que{" "}
            <span className="text-blue-600">Taxi à Orléans ?</span>
          </h2>
            ...
            <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm hover:border-blue-500 transition">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-xl font-bold uppercase">
                  Courses Express & Urgences
                </h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">
                Besoin d'un transport urgent ou d'une course express ? Contrairement
                aux taxis parfois indisponibles, nous trouvons une solution rapide
                pour vos impératifs.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm hover:border-blue-500 transition">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Pour aller à Orly ou Roissy depuis Orléans, le compteur d'un taxi
                peut vite grimper. Avec nous, le forfait est fixé à l'avance. Aucune
                surprise.
              </p>
            </div>
          </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8 mb-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={city}
                className="bg-white px-4 py-2 rounded-full text-xs font-bold text-slate-700 shadow-sm border border-slate-100 flex items-center gap-2"
              >
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <h2 className="text-2xl font-black text-slate-900 uppercase text-center mb-8">
          ...
          <div className="space-y-4">
            <details className="group bg-white border border-slate-200 rounded-lg overflow-hidden">
              ...
              <div className="p-4 text-sm text-slate-600 leading-relaxed border-t border-slate-100">
                Oui, les courses express sont au cœur de notre métier. Contactez-nous
                immédiatement au 06 34 60 57 99 pour vérifier la disponibilité d'un
                chauffeur en urgence.
              </div>
            </details>
            <details className="group bg-white border border-slate-200 rounded-lg overflow-hidden">
              <summary className="flex justify-between items-center p-4 font-bold cursor-pointer hover:bg-slate-50">
              ...
              <div className="p-4 text-sm text-slate-600 leading-relaxed border-t border-slate-100">
                Nos forfaits démarrent à 180€ pour Orly et 210€ pour Roissy CDG. Le
                tarif est fixe, bagages compris, peu importe la circulation.
              </div>
            </details>
            <details className="group bg-white border border-slate-200 rounded-lg overflow-hidden">
              <summary className="flex justify-between items-center p-4 font-bold cursor-pointer hover:bg-slate-50">
              ...
              <div className="p-4 text-sm text-slate-600 leading-relaxed border-t border-slate-100">
                Oui, nous assurons fréquemment la liaison Orléans vers Paris
                Austerlitz, Montparnasse ou Gare de Lyon pour vos correspondances TGV.
              </div>
            </details>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              <p className="text-slate-400 text-xs leading-relaxed text-justify">
                Partenaire expert depuis 2013. Nous assurons vos transports
                critiques, navettes VIP et déménagements avec une exigence de qualité
                unique. Licences et assurances à jour.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-4 text-sm font-bold">
                ...
                <div className="flex items-center gap-3 text-slate-400 mt-2">
                  <MapPin className="w-4 h-4 text-blue-600" /> Orléans & France
                  Entière
                </div>
              </div>
            </div>
